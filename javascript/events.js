$(document).ready(function(){
    ...
    $("#find-event").on("click", function(event) {
        ...
        $.ajax({
            ...
            for (var i = 0; i < 10; i++) {
                ...
                var eventDateString = moment(startTime).format('ddd, MMM Do, h:mm a');
    ...
    function displayEvents() {
        ...
        if ( (eventTitle !== undefined) && (eventVenue !== undefined)) {
            ...
            var row = $('<tr>').append('<td>' + '<p id="event-titles"><strong>' + eventTitle + '</strong>' + ' - ' + eventVenue + '<br>' + (moment(startTime).format('ddd, MMM Do, h:mm a')) + '<br>' + '</td>');
